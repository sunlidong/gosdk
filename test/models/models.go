...
type RentingHouseInfo struct {
	...
	RentingHouseInfo HouseInfo `json:RentHouseInfo`    //　房屋信息
	RentingAreaInfo  AreaInfo  `json:RentAreaInfo`     //　区域信息
	RentingOrderInfo OrderInfo `json:RentingOrderInfo` //　订单信息
}
